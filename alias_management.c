...
/**
 * print_alias - Function that adds, remove or show aliases
 * @data: Thestruct for the program's data
...
/**
 * get_alias - Function that add, remove or show aliases
...
/**
 * set_alias - function that add, or override alias
